...
const AdminPage = () => {
  ...
  const handleFoodSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${API_BASE_URL}/admin/create/food-item`, foodItem);
  ...
  const handleDeleteFood = async (id) => {
    ...
    try {
      await axios.delete(`${API_BASE_URL}/admin/food-item/${id}`);
  ...
  const handleProductSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${API_BASE_URL}/admin/create/product`, product);
