...
const Cart = () => {
  ...
  const toggleIngredient = (itemId, ingredientId) => {
  ...
  const calculateItemSubtotal = (item) => {
    ...
    const ingredientTotal =
      food.ingredients?.reduce((sum, ing) => {
        if (removed.includes(ing.id)) return sum;
                            ...
                            >
                              ...
                              <label className="flex items-center gap-2">
                                <input
                                  ...
                                  checked={removedIngredients[item.id]?.includes(ingredient.id) || false}
                                  onChange={() =>
                                    toggleIngredient(item.id, ingredient.id)
                                  }
                                />
